...
if(state is LoginSucceeded){
  if(state.loginModels.status==true){
    ...
    CacthHelper.saveData('takon', state.loginModels.data!.toaken).then((value){
    if(value !=null){
      ...
      child: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text("LOGIN",style: Theme.of(context).textTheme.headline!.copyWith(
                  color: Colors.black,
                  fontSize: 27,
...
Navigator.push(context, MaterialPageRoute(builder: (context) => RegtsterScreen(),));
                  }, child: Text("REGISTER")),
                ],
              ),
